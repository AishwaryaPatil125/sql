...
INSERT INTO series_details VALUE('Squid Game',2021,1,'Korean','Netflix',8,9.8);
...
ALTER TABLE series_details ADD COLUMN director VARCHAR(20)AFTER name;
...
ALTER TABLE web_series_details RENAME COLUMN ratings TO imdb_ratings;
